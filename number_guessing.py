...
def guess_number(low, high, num_attempts):
    ...
    The function prints the range to the user and informs the user of how many attempts they have. :3
    The function asks the user to guess the number the given number of times. :3
    You must use the random module's randint function to generate the pseudo-random integer.:3
    ...
    print(f"the range of values span from {low} to {high} and you have {num_attempts} attempts")
